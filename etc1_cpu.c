...
static void triangle_normal(void)
{
   ...
   etc1_decode_image(textureData, data, encoded_width, encoded_height, 3, encoded_width * 3);
   glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, encoded_width, encoded_height, 0, GL_RGB, GL_UNSIGNED_BYTE, data);
   if (data) {
       free(data);
   }
