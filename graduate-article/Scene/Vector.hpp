...
float cerp(const float u0, const float u1, const float u2, const float u3,
           float x);
vec2 cerp(const vec2& u0, const vec2& u1, const vec2& u2, const vec2& u3,
          float x);
vec3 cerp(const vec3& u0, const vec3& u1, const vec3& u2, const vec3& u3,
          float x);
vec4 cerp(const vec4& u0, const vec4& u1, const vec4& u2, const vec4& u3,
          float x);
...
struct mat3
{
  ...
  mat3(const float m00, const float m01, const float m02, const float m10,
...
mat4 perspectiveMatrixX(const float fov, const int width, const int height,
                        const float zNear, const float zFar);
mat4 perspectiveMatrixY(const float fov, const int width, const int height,
                        const float zNear, const float zFar);
mat4 orthoMatrixX(const float left, const float right, const float top,
...
mat4 glperspectiveMatrix(const float fov, const float zNear, const float zFar);
mat4 glperspectiveMatrixX(const float fov, const int width, const int height,
                          const float zNear, const float zFar);
mat4 glperspectiveMatrixY(const float fov, const int width, const int height,
                          const float zNear, const float zFar);
