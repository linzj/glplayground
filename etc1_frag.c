...
{
    loadWorker("etc1frag.glsl", &fragmentShaderSourceETC1, &fragmentShaderSourceETC1LineCount);
}
...
void initShader(void)
{
   ...
   GLuint fragmentShader =
     compileShaderSource (GL_FRAGMENT_SHADER, fragmentShaderSourceETC1LineCount, (const char**)fragmentShaderSourceETC1);
...
static void triangle_normal(void)
{
   ...
   glTexImage2D(GL_TEXTURE_2D, 0, GL_R8, encoded_width / 4 * 8, encoded_height / 4, 0, GL_RED, GL_UNSIGNED_BYTE, textureData);
